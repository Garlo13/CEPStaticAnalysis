 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.esper.impl.TimerImpl#getDefaultMethod <em>Default Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimerImpl extends MinimalEObjectImpl.Container implements Timer
{
  ...
  {
    return EsperPackage.Literals.TIMER;
  }
  ...
  public NotificationChain basicSetDefaultMethod(DefaultMethods newDefaultMethod, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EsperPackage.TIMER__DEFAULT_METHOD, oldDefaultMethod, newDefaultMethod);
  ...
  public void setDefaultMethod(DefaultMethods newDefaultMethod)
  {
    if (newDefaultMethod != defaultMethod)
    {
      ...
      if (defaultMethod != null)
        msgs = ((InternalEObject)defaultMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EsperPackage.TIMER__DEFAULT_METHOD, null, msgs);
      if (newDefaultMethod != null)
        msgs = ((InternalEObject)newDefaultMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EsperPackage.TIMER__DEFAULT_METHOD, null, msgs);
      msgs = basicSetDefaultMethod(newDefaultMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EsperPackage.TIMER__DEFAULT_METHOD, newDefaultMethod, newDefaultMethod));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EsperPackage.TIMER__DEFAULT_METHOD:
