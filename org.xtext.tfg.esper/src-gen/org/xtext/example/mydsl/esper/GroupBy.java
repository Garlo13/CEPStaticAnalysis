 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.esper.GroupBy#getAnything <em>Anything</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.esper.EsperPackage#getGroupBy()
 * @model
 * @generated
 */
public interface GroupBy extends EObject
{
   ...
   * @see org.xtext.example.mydsl.esper.EsperPackage#getGroupBy_Anything()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.esper.GroupBy#getAnything <em>Anything</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
